...
function verifyJWT(req, res, next) {
  ...
  jwt.verify(token, "your_secret_key", (err, decoded) => {
    ...
    // Check user role for authorization (you can replace with your own logic)
    ...
    const requestedEndpoint = `${req.method} ${req.url}`; // Include method and url of the endpoint
